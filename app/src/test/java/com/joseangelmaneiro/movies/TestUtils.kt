...
class TestUtils {
    ...
    companion object {
        ...
        fun createMovieEntity(): MovieEntity {
            return MovieEntity(VOTE_COUNT, MOVIE_ID, VIDEO, VOTE_AVERAGE, TITLE, POPULARITY,
        ...
        fun createMovieEntityList(numMovies: Int): List<MovieEntity> {
            ...
            for (i in 0 until numMovies) {
                val movie = MovieEntity(VOTE_COUNT, i, VIDEO, VOTE_AVERAGE, TITLE, POPULARITY,
        ...
        fun createMovie(): Movie {
            return Movie(MOVIE_ID, VOTE_AVERAGE, TITLE, POSTER_PATH, BACKDROPPATH, OVERVIEW,
                    RELEASE_DATE)
        }
        ...
        fun createMovieList(numMovies: Int): List<Movie> {
            ...
            for (i in 0 until numMovies) {
                val movie = Movie(i, VOTE_AVERAGE, TITLE, POSTER_PATH, BACKDROPPATH, OVERVIEW,
                        RELEASE_DATE)
                movies.add(movie)
            }
            return movies
